        ...
        return (
            <div className="space-y-6">
                ...
                <div className={`p-8 rounded-2xl text-center ${result.passed
                    ? 'bg-gradient-to-br from-[#7A85F0]/10 to-[#c41e18]/10 border border-[#7A85F0]/20'
                    : 'bg-gradient-to-br from-[#7A85F0]/10 to-orange-100 border border-[#7A85F0]/20'
                    }`}>
                    <div className={`w-20 h-20 rounded-full mx-auto mb-4 flex items-center justify-center ${result.passed
                        ? 'bg-gradient-to-br from-[#7A85F0] to-[#c41e18] shadow-lg shadow-[#7A85F0]/30'
                        : 'bg-gradient-to-br from-[#7A85F0] to-orange-400 shadow-lg shadow-[#7A85F0]/30'
                        }`}>
                        {result.passed ? (
                    ...
                    <h3 className={`text-2xl font-bold mb-2 ${result.passed ? 'text-[#7A85F0]' : 'text-[#7A85F0]'}`}>
                        {result.passed ? 'Congratulations!' : 'Keep Learning!'}
                    </h3>

                    <p className={`text-sm mb-6 ${result.passed ? 'text-[#7A85F0]/80' : 'text-[#7A85F0]/80'}`}>
                        {result.passed
                    ...
                    {!result.passed && (quizSettings.maxAttempts === 0 || true) && (
                        <button
                            onClick={handleRetry}
                            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-[#7A85F0] to-[#c41e18] text-white font-semibold hover:shadow-lg hover:shadow-[#7A85F0]/30 transition-all"
                        >
                            <FiRefreshCw size={18} />
                            Retry Quiz
                        </button>
                            ...
                            return (
                                <div
                                    ...
                                    className={`p-4 rounded-xl border ${r.correct
                                        ? 'bg-[#7A85F0]/5 border-[#7A85F0]/20'
                                        : 'bg-red-50 border-red-100'
                                        }`}
                                >
                                    <div className="flex items-start gap-3">
                                        <div className={`w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${r.correct ? 'bg-[#7A85F0] text-white' : 'bg-red-500 text-white'}`}>
                                        ...
                                        <div className="flex-1">
                                            ...
                                            {!r.correct && r.correctAnswer && (
                                                <p className="text-xs text-[#7A85F0] mt-1">
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#7A85F0] to-[#c41e18] flex items-center justify-center shadow-lg shadow-[#7A85F0]/20">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#7A85F0]/10 text-[#7A85F0] text-sm font-semibold">
                        <FiList size={14} />
            ...
            <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                <motion.div
                    className="h-full bg-gradient-to-r from-[#7A85F0] to-[#7A85F0]"
                    initial={{ width: 0 }}
                ...
                >
                    ...
                    <div className="mb-6">
                        ...
                        {currentQuestion.hint && (
                            <p className="text-sm text-[#7A85F0] mt-2 flex items-center gap-1">
                            ...
                            {currentQuestion.options.map((option, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <span className={`flex-1 font-medium ${isSelected ? 'text-[#7A85F0]' : 'text-gray-700'}`}>
                                            {option.text}
                                        </span>
                                        {isSelected && (
                                            <FiCheck className="text-[#7A85F0]" size={20} />
                                        )}
                                    </button>
                                );
                            })}
                    ...
                    {currentQuestion.type === 'short' && (
                        <div>
                            <textarea
                                ...
                                rows={4}
                                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#7A85F0] focus:ring-2 focus:ring-[#7A85F0]/20 outline-none text-gray-700 resize-none transition-all"
                            />
                        </div>
                    )}
                </motion.div>
            ...
            <div className="flex items-center justify-between">
                ...
                {currentIndex === questions.length - 1 ? (
                    <button
                        ...
                        disabled={loading}
                        className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-[#7A85F0] to-[#c41e18] text-white font-semibold hover:shadow-lg hover:shadow-[#7A85F0]/30 transition-all disabled:opacity-50"
                    >
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-5 py-3 rounded-xl bg-[#7A85F0] text-white font-semibold hover:bg-[#c41e18] transition-all"
                    >
                        Next
