        ...
        <div className="space-y-4">
            ...
            <div className="bg-white border border-gray-200 rounded-md p-4 shadow-sm">
                <div className="relative">
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 text-sm text-gray-800 placeholder-gray-400 bg-gray-50 border border-gray-200 rounded-md focus:outline-none focus:border-[#7A85F0] focus:bg-white transition-colors work"
                    />
            ...
            <div className="bg-white border border-gray-200 rounded-md shadow-sm overflow-hidden">
                <div className="flex items-center gap-2 px-4 py-3 bg-gray-50 border-b border-gray-200">
                    <HiOutlineSparkles className="text-[#7A85F0]" />
            ...
            <div className="bg-white border border-gray-200 rounded-md shadow-sm overflow-hidden">
                <div className="flex items-center gap-2 px-4 py-3 bg-gray-50 border-b border-gray-200">
                    <LuFilter className="text-[#7A85F0]" />
                    <h3 className={`font-semibold text-gray-800 outfit text-sm ${bengaliClass}`}>
                        {language === 'bn' ? '?????????' : 'Categories'}
                    </h3>
                    {selectedCategories.length > 0 && (
                        <span className="ml-auto text-xs bg-[#7A85F0] text-white px-2 py-0.5 rounded-full">
                ...
                <div className="p-3 space-y-1">
                    ...
                    >
                        <div className={`w-4 h-4 rounded border-2 flex items-center justify-center ${selectedCategories.length === 0 ? "border-[#7A85F0] bg-[#7A85F0]" : "border-gray-300"
                            }`}>
                            {selectedCategories.length === 0 && (
                    ...
                    {status === "loading" && (
                        <div className="text-center py-4">
                            <div className="w-5 h-5 border-2 border-[#7A85F0] border-t-transparent rounded-full animate-spin mx-auto"></div>
                        </div>
                    )}
