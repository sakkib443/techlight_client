...
export default function LessonCreateTab() {
    ...
    const inputClass = "w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#E31E27] focus:ring-2 focus:ring-[#E31E27]/20 outline-none text-sm transition-all bg-white text-gray-700 placeholder:text-gray-400";
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-5">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2">
                            <div className="w-8 h-8 rounded-lg bg-[#E31E27]/20 flex items-center justify-center text-[#E31E27]">
                                <FiBook size={14} />
                            </div>
                            <div>
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="flex items-center gap-2 bg-[#E31E27] hover:bg-[#c41e18] text-white px-5 py-2.5 rounded-lg font-medium text-sm transition-all disabled:opacity-50"
                        >
                            <FiPlus size={16} />
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-[#E31E27] hover:bg-[#f59e0b] text-white px-5 py-2.5 rounded-lg font-medium text-sm transition-all"
                        >
                            <FiCheck size={16} />
                            Finish
                        </button>
            ...
            {createdLessons.length > 0 && (
                <div className="bg-[#E31E27]/10 border border-[#E31E27]/30 rounded-xl overflow-hidden">
                    <button
                        onClick={() => setShowCreatedList(!showCreatedList)}
                        className="w-full flex items-center justify-between px-4 py-3 hover:bg-[#E31E27]/5 transition-colors"
                    >
                        <div className="flex items-center gap-2">
                            <FiCheck className="text-[#E31E27]" size={16} />
                            <span className="font-semibold text-[#E31E27] text-sm">
                    ...
                    {showCreatedList && (
                        <div className="px-4 pb-3 border-t border-[#E31E27]/20 pt-2">
                            <div className="flex flex-wrap gap-2">
                                {createdLessons.map((lesson, idx) => (
                                    <div key={lesson._id || idx} className="flex items-center gap-2 px-3 py-1.5 bg-white rounded-lg border border-gray-200">
                                        <span className="w-5 h-5 rounded bg-[#E31E27] text-white flex items-center justify-center font-bold text-xs">
                                            {lesson.order}
                                        </span>
                                        <span className="text-sm text-gray-700">{lesson.title}</span>
                                        <span className="text-[10px] text-gray-400 capitalize">({lesson.lessonType})</span>
                                        <FiCheck className="text-[#E31E27]" size={12} />
                                    </div>
                                ))}
                            </div>
                        </div>
            ...
            <div className="bg-white p-5 rounded-xl border border-gray-200 space-y-4">
                <div className="flex items-center gap-3 pb-3 border-b border-gray-100">
                    <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[#E31E27] to-[#f59e0b] flex items-center justify-center">
                        ...
                        {[
                            ...
                            <button
                                ...
                                className={`flex items-center gap-1.5 px-3 py-2 rounded-lg border text-sm font-medium transition-all ${formData.lessonType === type.value
                                    ? 'border-[#E31E27] bg-[#E31E27] text-white'
                ...
                <div className="flex flex-wrap items-center gap-4 pt-2 border-t border-gray-100">
                        ...
                        <div className="flex bg-gray-100 rounded-lg p-0.5">
                            <button
                                ...
                                className={`px-4 py-1.5 rounded-md text-sm font-medium transition-all ${formData.isPublished
                                    ? 'bg-[#E31E27] text-white shadow-sm'
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            onChange={handleChange}
                            className="w-4 h-4 rounded border-gray-300 text-[#E31E27] focus:ring-[#E31E27]"
                        />
                    ...
                    <div className="flex items-center gap-2 ml-auto">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            min="1"
                            className="w-16 px-2 py-1.5 rounded-lg border border-gray-200 text-sm text-center focus:border-[#E31E27] outline-none"
                        />
                    </div>
                </div>
            </div>
                    ...
                    {tabs.map(tab => (
                        <button
                            ...
                            className={`flex items-center gap-1.5 px-4 py-3 font-medium text-sm border-b-2 transition-all whitespace-nowrap ${activeTab === tab.id
                                ? 'border-[#E31E27] text-[#E31E27] bg-[#E31E27]/5'
                        ...
                        >
                            ...
                            {tab.label}
                            {tab.badge > 0 && (
                                <span className="ml-1 px-1.5 py-0.5 rounded-full text-xs font-bold bg-[#E31E27]/20 text-[#E31E27]">
                                    {tab.badge}
                                </span>
                            )}
                        </button>
                    ...
                    {activeTab === 'questions' && (
                        <div className="space-y-4">
                            ...
                            {formData.questions?.length > 0 && (
                                <div className="mt-4 p-4 bg-[#E31E27]/10 rounded-xl border border-[#E31E27]/20 space-y-3">
                                    <h4 className="font-semibold text-gray-800 text-sm flex items-center gap-2">
                                        <FiSettings className="text-[#E31E27]" />
                                        Quiz Settings
                                    </h4>
                                        ...
                                        <div className="flex flex-col justify-center gap-1.5">
                                            <label className="flex items-center gap-2 text-xs">
                                                <input
                                                    ...
                                                    className="w-3.5 h-3.5 rounded border-gray-300 text-[#E31E27]"
                                                />
                                                Show Answers
                                            </label>
                                            <label className="flex items-center gap-2 text-xs">
                            ...
                            <div className="p-4 bg-gray-50 rounded-xl border border-gray-200">
                                ...
                                <div className="grid grid-cols-4 gap-3 text-center">
                                    <div className="p-2 bg-white rounded-lg">
                                        <p className="text-xl font-bold text-[#E31E27]">{formData.videoUrl ? '1' : '0'}</p>
                                        <p className="text-xs text-gray-500">Video</p>
                                    </div>
                                    <div className="p-2 bg-white rounded-lg">
                                        <p className="text-xl font-bold text-[#E31E27]">{formData.documents?.length || 0}</p>
