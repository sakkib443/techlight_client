            ...
            <div className="group w-full flex flex-col md:flex-row bg-white dark:bg-[#0d0d0d] rounded-md border border-gray-100 dark:border-white/10 overflow-hidden hover:shadow-xl transition-all duration-300">
                ...
                <div className="relative w-full md:w-[35%] h-56 md:h-auto shrink-0 overflow-hidden p-3">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/20 backdrop-blur-[1px]">
                        <Link href={detailUrl} className="w-12 h-12 bg-white/30 backdrop-blur-md rounded-full flex items-center justify-center text-white border border-white/50 hover:bg-[#E31E27] hover:border-[#E31E27] transition-colors">
                ...
                <div className="flex-1 p-6 border-r border-gray-50 flex flex-col justify-center">
                    <Link href={detailUrl}>
                        <h3 className={`text-xl font-bold text-slate-800 leading-tight mb-2 hover:text-[#E31E27] transition-colors ${bengaliClass}`}>
                            {title}
                        </h3>
                    </Link>
                    ...
                    <ul className="space-y-2 mb-4">
                        <li className="flex items-start gap-2 text-sm text-slate-600">
                            <LuLayers className="text-[#E31E27] mt-0.5 shrink-0" size={16} />
                ...
                <div className="w-full md:w-[25%] p-6 bg-gray-50/50 flex flex-col items-center justify-center text-center gap-1 border-l border-gray-100">
                    ...
                    <div className="flex w-full justify-end gap-2 mb-2 text-slate-400">
                        <button className="hover:text-[#E31E27]"><LuList size={18} /></button>
                    ...
                    <div className="flex items-center gap-3 w-full">
                        <button
                            ...
                            disabled={isAdded}
                            className={`p-2.5 border rounded-md transition-colors shadow-sm ${isAdded ? 'bg-emerald-500 border-emerald-500 text-white' : 'bg-white border-slate-200 text-slate-600 hover:text-[#E31E27] hover:border-[#E31E27]'}`}
                        >
                            {isAdded ? <LuCheck size={20} /> : <LuShoppingCart size={20} />}
                        </button>
                        <Link
                            href={detailUrl}
                            className="flex-1 py-2.5 bg-white border border-[#E31E27] text-[#E31E27] rounded-md text-sm font-normal hover:bg-[#E31E27] hover:text-white transition-all shadow-sm flex items-center justify-center gap-2"
                        >
                            Details
                        </Link>
                    </div>
            ...
            <div className={`relative h-full bg-white dark:bg-[#0d0d0d] rounded-md border border-gray-100 dark:border-white/10 overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col`}>
                ...
                <div className="relative h-48 w-full overflow-hidden shrink-0 p-3">
                    ...
                    <div className="absolute top-3 left-3">
                        <span className={`inline-block px-3 py-1 rounded-md text-xs font-bold text-white shadow-sm bg-[#E31E27]`}>
                            {type}
                        </span>
                    </div>
                ...
                <div className="p-4 flex flex-col flex-1">
                    ...
                    <div className="flex items-center gap-2 mb-2 text-slate-500">
                        <LuLayoutGrid className="text-[#E31E27]" />
                    ...
                    <Link href={detailUrl} className="mb-3 block">
                        <h3 className={`text-lg font-bold text-slate-800 leading-tight line-clamp-2 hover:text-[#E31E27] transition-colors ${bengaliClass}`}>
                            {title}
                        </h3>
                    </Link>
                    ...
                    <div className="flex items-center gap-4 mb-4 text-xs text-slate-500 font-medium pb-4 border-b border-slate-50">
                        <div className="flex items-center gap-1.5">
                            <LuLayers className="text-[#E31E27]" />
                            <span>{version}</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                    ...
                    <div className="flex items-center justify-between mb-4">
                        <div>
                            ...
                            <div className="flex items-center gap-2">
                                <span className="text-xl font-bold text-[#E31E27] font-outfit">
                                    ?{displayPrice?.toLocaleString()}
                                </span>
                                {hasDiscount && (
                    ...
                    <div className="grid grid-cols-2 gap-3 mt-auto">
                        <Link
                            href={detailUrl}
                            className="flex items-center justify-center gap-2 py-2.5 bg-[#E31E27] text-white rounded-md text-sm font-normal hover:bg-[#c41e18] transition-colors"
                        >
                            <LuEye size={16} />
                            Details
                        </Link>
                        <button
                            ...
                            className={`flex items-center justify-center gap-2 py-2.5 border rounded-md text-sm font-normal transition-colors ${isAdded
                                ...
                                : 'bg-white border-[#E31E27] text-[#E31E27] hover:bg-red-50'
                                }`}
                        >
