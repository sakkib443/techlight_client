        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-[#0a0a0a]">
                <div className="flex flex-col items-center gap-4">
                    <LuLoader className="animate-spin text-[#E31E27]" size={40} />
    ...
    if (checkoutItems.length === 0) {
        return (
            <div className="min-h-screen bg-white dark:bg-[#0a0a0a] flex flex-col items-center justify-center p-6 text-center">
                ...
                <button onClick={() => router.push('/courses')} className={`px-8 py-3 bg-[#E31E27] text-white rounded-md font-normal text-sm uppercase tracking-widest hover:bg-[#c41e18] transition-all ${bengaliClass}`}>
                    Browse Courses
                </button>
            </div>
        );
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-[#0a0a0a] py-12 lg:py-20">
            <div className="container mx-auto px-4 lg:px-32">
                ...
                <div className="flex items-center gap-4 mb-10">
                    <button onClick={() => router.back()} className="w-10 h-10 flex items-center justify-center bg-white dark:bg-white/5 rounded-md border border-slate-200 dark:border-white/10 text-slate-400 hover:text-[#E31E27] transition-all">
                    ...
                    <div className="flex-1 w-full space-y-6">
                        <div className="bg-white dark:bg-white/5 p-6 lg:p-8 rounded-md border border-slate-200 dark:border-white/10 shadow-sm">
                            <div className="flex items-center gap-3 mb-8">
                                <div className="w-10 h-10 bg-slate-50 dark:bg-white/10 rounded-md flex items-center justify-center text-[#E31E27] border border-slate-100 dark:border-white/10">
                                    <LuUser size={20} />
                                </div>
                            ...
                            <form onSubmit={handlePlaceOrder} className="space-y-6">
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                className={`w-full pl-12 pr-6 py-4 outline-none transition-all font-normal text-slate-700 dark:text-white rounded-md ${formErrors.fullName ? 'border-2 border-red-500 bg-red-50 dark:bg-red-500/10 focus:border-red-600' : 'bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 focus:border-[#E31E27] focus:bg-white dark:focus:bg-white/10'}`}
                                            />
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                className={`w-full pl-12 pr-6 py-4 outline-none transition-all font-normal text-slate-700 dark:text-white rounded-md ${formErrors.email ? 'border-2 border-red-500 bg-red-50 dark:bg-red-500/10 focus:border-red-600' : 'bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 focus:border-[#E31E27] focus:bg-white dark:focus:bg-white/10'}`}
                                            />
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                className={`w-full pl-12 pr-6 py-4 outline-none transition-all font-normal text-slate-700 dark:text-white rounded-md ${formErrors.phone ? 'border-2 border-red-500 bg-red-50 dark:bg-red-500/10 focus:border-red-600' : 'bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 focus:border-[#E31E27] focus:bg-white dark:focus:bg-white/10'}`}
                                            />
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <button
                                            ...
                                            className={`p-5 rounded-md border-2 flex items-center gap-4 transition-all ${paymentMethod === 'manual'
                                                ? 'border-[#E31E27] bg-[#E31E27]/5'
                                                : 'border-slate-100 dark:border-white/10 bg-white dark:bg-white/5 hover:border-slate-200'
                                                }`}
                                        >
                                            <div className="w-10 h-10 bg-[#E31E27] rounded-md flex items-center justify-center text-white">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full px-5 py-3 outline-none transition-all font-normal text-slate-700 dark:text-white text-sm rounded-md ${formErrors.senderNumber ? 'border-2 border-red-500 bg-red-50 dark:bg-red-500/10 focus:border-red-600' : 'bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 focus:border-[#E31E27]'}`}
                                                    />
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full px-5 py-3 outline-none transition-all font-normal text-slate-700 dark:text-white text-sm rounded-md ${formErrors.transactionId ? 'border-2 border-red-500 bg-red-50 dark:bg-red-500/10 focus:border-red-600' : 'bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 focus:border-[#E31E27]'}`}
                                                    />
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full px-5 py-3 outline-none transition-all font-normal text-slate-700 dark:text-white text-sm rounded-md ${formErrors.time ? 'border-2 border-red-500 bg-red-50 dark:bg-red-500/10 focus:border-red-600' : 'bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 focus:border-[#E31E27]'}`}
                                                    />
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full px-5 py-3 outline-none transition-all font-normal text-slate-700 dark:text-white text-sm rounded-md ${formErrors.date ? 'border-2 border-red-500 bg-red-50 dark:bg-red-500/10 focus:border-red-600' : 'bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 focus:border-[#E31E27]'}`}
                                                    />
                                ...
                                <div className="pt-6">
                                    <button
                                        ...
                                        className={`w-full py-4 bg-[#E31E27] text-white rounded-md font-normal text-sm uppercase tracking-widest hover:bg-[#c41e18] transition-all flex items-center justify-center gap-3 ${bengaliClass}`}
                                    >
                                ...
                                {checkoutItems.map((item) => (
                                    <div key={item.id} className="flex gap-4 items-center">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <span className="text-[8px] font-bold text-[#E31E27] bg-[#E31E27]/5 px-1.5 py-0.5 rounded-md uppercase tracking-widest">{item.type}</span>
                                        </div>
                            ...
                            <div className="pt-6 space-y-4 border-t border-slate-100 dark:border-white/5">
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 px-4 py-3 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-md text-[10px] font-bold uppercase focus:border-[#E31E27] outline-none"
                                    />
                                    <button
                                        onClick={handleApplyCoupon} disabled={couponApplying}
                                        className="px-4 py-3 bg-slate-900 dark:bg-white dark:text-slate-900 text-white font-bold text-[10px] rounded-md hover:bg-[#E31E27] dark:hover:bg-[#E31E27] dark:hover:text-white transition-all disabled:opacity-50"
                                    >
                                        Apply
                                    </button>
                                </div>
                                ...
                                <div className="pt-6 border-t border-slate-100 dark:border-white/5">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-2xl font-black text-[#E31E27] outfit">৳{finalAmount.toLocaleString()}</span>
                                    </div>
                                </div>
                            </div>
