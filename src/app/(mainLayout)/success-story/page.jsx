  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#ecfcfb] via-white to-[#ecfcfb]">
      ...
      <section className="relative overflow-hidden border-b border-gray-100">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-[#E31E27]/10 to-transparent rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-gradient-to-tl from-[#E31E27]/10 to-transparent rounded-full blur-3xl"></div>
        ...
        <div className="container mx-auto px-4 lg:px-32 py-12 lg:py-16 relative z-10">
          <div className={`text-center max-w-3xl mx-auto transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
            ...
            <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-white border border-gray-200 rounded-full shadow-sm">
              <HiOutlineSparkles className="text-[#E31E27] text-lg" />
            ...
            <h1 className={`text-3xl sm:text-4xl lg:text-5xl font-bold outfit text-gray-800 mb-4 ${bengaliClass}`}>
              {language === "bn" ? "????????????? " : "Student "}
              <span className="bg-gradient-to-r from-[#E31E27] to-[#38a89d] bg-clip-text text-transparent">
              ...
              {stats.map((stat, index) => {
                ...
                return (
                  <div key={index} className="flex items-center gap-3 bg-white px-5 py-3 rounded-xl shadow-sm border border-gray-100">
                    <div className="w-10 h-10 bg-gradient-to-br from-[#E31E27]/10 to-[#E31E27]/5 rounded-lg flex items-center justify-center">
                      <Icon className="text-[#E31E27] text-lg" />
                    </div>
            ...
            <div className="flex items-center justify-center gap-2">
              <div className="flex">
                {[1, 2, 3, 4, 5].map(i => (
                  <FaStar key={i} className="text-[#E31E27] text-sm" />
                ))}
              </div>
      ...
      <section className="container mx-auto px-4 lg:px-32 py-12">
          ...
          {filters.map((filter) => (
            <button
              ...
              className={`relative px-6 py-3 rounded-xl font-medium work transition-all duration-300 ${bengaliClass} ${activeFilter === filter.key
                ? "bg-gradient-to-r from-[#E31E27] to-[#38a89d] text-white shadow-lg shadow-[#E31E27]/30"
                : "bg-white text-gray-600 border border-gray-200 hover:border-[#E31E27]/50 hover:text-[#E31E27]"
                }`}
            >
              {filter.label}
            </button>
              ...
              <div className="relative rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-white">
                ...
                <div className="relative aspect-video">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-16 h-16 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-xl transform scale-90 group-hover:scale-100 transition-all duration-300 group-hover:bg-[#E31E27]">
                      <LuPlay className="w-6 h-6 text-[#E31E27] group-hover:text-white ml-1" />
                    </div>
                  </div>

                  {/* Badge */}
                  <div className={`absolute top-3 left-3 px-3 py-1 bg-[#E31E27] text-white text-xs font-medium rounded-lg ${bengaliClass}`}>
        ...
        <div className={`text-center mt-12 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
          <div className="bg-gradient-to-r from-[#E31E27]/10 via-white to-[#E31E27]/10 rounded-2xl p-8 border border-gray-100">
            ...
            <Link
              href="/courses"
              className={`inline-flex items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-[#E31E27] to-[#38a89d] text-white rounded-xl font-semibold work hover:shadow-xl hover:shadow-[#E31E27]/30 transition-all duration-300 group ${bengaliClass}`}
            >
