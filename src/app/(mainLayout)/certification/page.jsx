    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 lg:px-32">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-white border border-gray-200 rounded-full shadow-sm">
              <LuAward className="text-[#E31E27] text-lg" />
            ...
            <h1 className={`text-3xl lg:text-4xl font-bold outfit text-gray-800 mb-4 ${bengaliClass}`}>
              {t("certificationPage.title1")}<span className="text-[#E31E27]">{t("certificationPage.title2")}</span>
            </h1>
        ...
        <div className="bg-white border border-gray-200 rounded-md p-6 shadow-sm">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-md focus:ring-2 focus:ring-[#E31E27] focus:border-[#E31E27] outline-none transition-all text-sm"
          ...
          <div className="flex justify-end mt-4">
            <button
              ...
              disabled={isLoading}
              className={`flex items-center gap-2 px-6 py-3 bg-[#E31E27] hover:bg-[#38a89d] text-white font-medium rounded-md transition-all hover:shadow-lg disabled:opacity-50 ${bengaliClass}`}
            >
              {isLoading ? (
      ...
      <section className="container mx-auto px-4 lg:px-32 pt-6 pb-4">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-center gap-2 px-4 text-center md:flex-row md:justify-between md:text-left">
          ...
          <Link
            href="#"
            className={`flex items-center gap-2 rounded-full px-12 py-4 bg-white text-[#E31E27] font-bold hover:shadow-lg transition-all ${bengaliClass}`}
          >
        ...
        <div className="bg-gradient-to-r from-[#E31E27] to-[#38a89d] rounded-md p-8 text-white">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <a
              ...
              className={`inline-flex items-center gap-2 px-6 py-3 bg-white text-[#E31E27] font-medium rounded-md hover:shadow-lg transition-all shrink-0 ${bengaliClass}`}
            >
