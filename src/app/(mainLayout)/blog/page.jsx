        ...
        <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] font-poppins antialiased">
            ...
            <section className="relative py-12 lg:py-16 bg-slate-50 dark:bg-[#0a0a0a] overflow-hidden">
                ...
                <div className="container mx-auto px-4 lg:px-32 relative z-10">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 mb-4 px-4 py-1.5 rounded-full bg-[#FEE2E2] border border-[#E31E27]/20">
                            <LuBookOpen className="text-[#E31E27]" size={14} />
                            <span className={`text-xs font-semibold text-[#E31E27] uppercase tracking-wider ${bengaliClass}`}>
                        ...
                        <h1 className={`text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-3 tracking-tight ${bengaliClass}`}>
                            ...
                            <span className="text-[#E31E27]">{language === 'bn' ? 'অনুপ্রেরণা' : 'Inspiration'}</span>
                        </h1>
            ...
            <div className="container mx-auto px-4 lg:px-32 py-8">
                    ...
                    <div className="lg:col-span-2 h-full">
                        {featured ? (
                            <Link href={`/blog/${featured.slug}`} className="group block h-full">
                                <div className="bg-white dark:bg-[#111] rounded-2xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-800 h-full flex flex-col hover:shadow-xl hover:shadow-[#E31E27]/5 transition-all duration-300">
                                    <div className="relative h-[320px] lg:h-[350px] overflow-hidden">
                                        {featured.thumbnail ? (
                                            ...
                                            <div className="w-full h-full bg-gradient-to-br from-[#E31E27]/20 via-[#E31E27]/10 to-amber-500/10 flex items-center justify-center">
                                                <LuBookOpen className="text-[#E31E27]/40" size={60} />
                                            </div>
                                        )}
                                        <div className="absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-transparent" />
                                        <span className="absolute top-4 left-4 px-3 py-1.5 rounded-lg bg-[#E31E27] text-white text-[10px] font-bold uppercase tracking-wide">
                                            {featured.category?.name || 'Featured'}
                                        </span>
                                    </div>

                                    <div className="p-6 flex-1 flex flex-col">
                                        <h2 className={`text-lg md:text-xl font-bold text-gray-900 dark:text-white mb-2.5 leading-snug group-hover:text-[#E31E27] transition-colors line-clamp-2 ${bengaliClass}`}>
                                            {featured.title}
                                        </h2>
                                        ...
                                        <div className="flex items-center gap-3 text-sm pt-4 border-t border-gray-100 dark:border-gray-800">
                                            <div className="w-8 h-8 rounded-full bg-[#E31E27] flex items-center justify-center text-white text-xs font-bold">
                            ...
                            <div className="h-full min-h-[400px] rounded-2xl bg-white dark:bg-[#111] border border-gray-100 dark:border-gray-800 flex flex-col items-center justify-center gap-3">
                                <div className="w-16 h-16 bg-[#FEE2E2] rounded-2xl flex items-center justify-center">
                                    <LuBookOpen className="text-[#E31E27]" size={28} />
                                </div>
                            ...
                            {['popular', 'recent'].map((tab) => (
                                <button
                                    ...
                                    className={`flex-1 py-2 rounded-lg text-xs font-semibold transition-all ${activeTab === tab
                                        ? 'bg-[#E31E27] text-white shadow-md shadow-[#E31E27]/20'
                                    ...
                                    >
                                        <div className="w-16 h-16 relative rounded-lg overflow-hidden flex-shrink-0 border border-gray-100 dark:border-gray-800">
                                            {blog.thumbnail ? (
                                                ...
                                                <div className="w-full h-full bg-[#FEE2E2] dark:bg-[#E31E27]/10 flex items-center justify-center">
                                                    <LuBookOpen className="text-[#E31E27]/50" size={16} />
                                                </div>
                                            )}
                                        </div>
                                        <div className="flex-1 min-w-0 py-0.5">
                                            <h4 className={`font-semibold text-gray-800 dark:text-white text-xs leading-snug line-clamp-2 group-hover:text-[#E31E27] transition-colors ${bengaliClass}`}>
                                                {blog.title}
                                            </h4>
                ...
                {blogs.length === 0 ? (
                    ...
                    >
                        <div className="w-16 h-16 mx-auto mb-5 bg-[#FEE2E2] rounded-2xl flex items-center justify-center">
                            <LuBookOpen className="text-[#E31E27]" size={28} />
                        </div>
                        ...
                        {blogs.map((blog, index) => (
                            ...
                            >
                                <Link href={`/blog/${blog.slug}`} className="block">
                                    <div className="bg-white dark:bg-[#111] rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-800 hover:border-[#E31E27]/20 transition-all duration-300 hover:shadow-xl hover:shadow-[#E31E27]/5 hover:-translate-y-1">
                                        {/* Image */}
                                        <div className="relative h-48 overflow-hidden">
                                            {blog.thumbnail ? (
                                                ...
                                                <div className="w-full h-full bg-gradient-to-br from-[#E31E27]/10 via-[#E31E27]/5 to-amber-500/5 flex items-center justify-center">
                                                    <LuBookOpen className="text-[#E31E27]/30" size={36} />
                                                </div>
                                            )}
                                            ...
                                            <span className="absolute top-3 right-3 px-2.5 py-1 rounded-md bg-[#E31E27]/90 backdrop-blur-sm text-[10px] font-bold text-white flex items-center gap-1">
                                                <LuClock size={10} />
                                                5 {text.min}
                                            </span>
                                        </div>
                                        ...
                                        <div className="p-5">
                                            <div className="flex items-center gap-2.5 mb-3">
                                                <div className="w-7 h-7 rounded-full bg-[#E31E27] flex items-center justify-center text-white text-[10px] font-bold">
                                            ...
                                            <h3 className={`text-sm font-bold text-gray-900 dark:text-white group-hover:text-[#E31E27] transition-colors line-clamp-2 mb-2 leading-snug ${bengaliClass}`}>
                                                {blog.title}
                                            </h3>
                                            ...
                                            <div className="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-800">
                                                <span className={`text-xs font-semibold text-[#E31E27] flex items-center gap-1.5 ${bengaliClass}`}>
                                                    {text.readMore}
                ...
                {totalPages > 1 && (
                    <div className="flex justify-center items-center gap-2 mt-12">
                        <button
                            ...
                            className="w-10 h-10 rounded-xl bg-white dark:bg-[#111] border border-gray-200 dark:border-gray-800 flex items-center justify-center text-gray-500 disabled:opacity-30 hover:bg-[#E31E27] hover:border-[#E31E27] hover:text-white transition-all"
                        >
                        ...
                        {Array.from({ length: Math.min(5, totalPages) }, (_, i) => i + 1).map((page) => (
                            <button
                                ...
                                className={`w-10 h-10 rounded-xl font-bold text-xs transition-all ${currentPage === page
                                    ? 'bg-[#E31E27] text-white shadow-lg shadow-[#E31E27]/25'
                                    : 'bg-white dark:bg-[#111] border border-gray-200 dark:border-gray-800 text-gray-500 hover:bg-[#E31E27] hover:border-[#E31E27] hover:text-white'
                                    }`}
                            >
                                {page}
                            </button>
