...
const WhatsAppButton = ({ courseTitle }) => {
  ...
  const handleClick = () => {
    ...
    const msg = encodeURIComponent(`Hi, I'm interested in the course: ${courseTitle}`);
  ...
  return (
    <button
      onClick={handleClick}
      className="w-full py-2.5 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-semibold rounded-xl flex items-center justify-center gap-2 transition-colors"
    >
                ...
                <div className="bg-white dark:bg-[#111] rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm overflow-hidden">
                  ...
                  <div className="p-5 space-y-5">
                    ...
                    <div className="space-y-2.5">
                      ...
                      <WhatsAppButton courseTitle={currentCourse.title} />
                    </div>
