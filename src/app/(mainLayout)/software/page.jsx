...
const LoadingFallback = () => (
    <div className="flex items-center justify-center py-20">
        <div className="w-8 h-8 border-4 border-[#7A85F0] border-t-transparent rounded-full animate-spin"></div>
    </div>
);
                ...
                <div className="container mx-auto px-4 lg:px-32 py-10 lg:py-12 relative z-10">
                    <div className="text-center max-w-3xl mx-auto">
                        ...
                        <div className="inline-flex items-center gap-2 mb-3 px-3 py-1.5 bg-[#7A85F0]/10 dark:bg-white/5 border border-[#7A85F0]/20 dark:border-white/10 rounded-full">
                            <LuDownload className="text-[#7A85F0] text-base" />
                        ...
                        <h1 className={`text-2xl sm:text-3xl lg:text-4xl font-bold outfit text-gray-800 dark:text-white mb-2 ${bengaliClass}`}>
                            {language === 'bn' ? '??????' : 'Our Software '}<span className="text-[#7A85F0]">{language === 'bn' ? ' ????????? ???????' : 'Solutions'}</span>
                        </h1>
                        ...
                        <div className="flex flex-wrap justify-center gap-6">
                            <div className="flex items-center gap-2">
                                <div className="w-9 h-9 bg-[#7A85F0]/10 dark:bg-white/5 rounded-md flex items-center justify-center">
                                    <LuDownload className="text-[#7A85F0] text-base" />
                                </div>
                            ...
                            <div className="flex items-center gap-2">
                                <div className="w-9 h-9 bg-[#7A85F0]/10 dark:bg-white/5 rounded-md flex items-center justify-center">
                                    <LuCpu className="text-[#7A85F0] text-base" />
                                </div>
                                <div className="text-left">
