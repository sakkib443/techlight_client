              ...
              <div className="w-full max-w-md mx-auto">
                <div className="mb-8">
                  ...
                  <p className={`text-gray-500 text-sm ${bengaliClass}`}>
                    ...
                    <Link href="/register" className="text-[#E31E27] font-semibold hover:underline">
                ...
                <form className="space-y-5" onSubmit={handleLogin}>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-11 pr-12 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:border-[#E31E27] focus:ring-2 focus:ring-[#E31E27]/20 outline-none transition ${bengaliClass}`}
                      />
                      <button
                        type="button"
                        onClick={() => setShowPassword(!showPassword)}
                        className="absolute right-4 top-3.5 text-gray-400 hover:text-[#E31E27] transition"
                      >
                  ...
                  <div className="flex items-center justify-between">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <div className={`w-5 h-5 rounded border-2 flex items-center justify-center transition ${rememberMe ? 'bg-[#E31E27] border-[#E31E27]' : 'border-gray-300'}`}>
                    ...
                    <Link href="/forgot-password" className={`text-sm text-[#E31E27] hover:underline font-medium ${bengaliClass}`}>
