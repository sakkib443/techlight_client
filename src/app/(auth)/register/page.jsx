      ...
      <div className="container mx-auto px-4 lg:px-16">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-5 gap-0 bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
            ...
            <div className="lg:col-span-2 bg-gradient-to-br from-[#E31E27] to-[#38a89d] p-8 lg:p-12 text-white relative overflow-hidden">
              {/* Background Pattern */}
              ...
              <div className="max-w-md mx-auto">
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className={`w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:border-[#E31E27] focus:ring-2 focus:ring-[#E31E27]/20 outline-none transition ${bengaliClass}`}
                      />
                    </div>
                    <div className="relative">
                      <FiUser className="absolute left-4 top-3.5 text-gray-400" size={18} />
                    ...
                    <div>
                      <div className="relative">
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          required
                          className={`w-full pl-11 pr-10 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:border-[#E31E27] focus:ring-2 focus:ring-[#E31E27]/20 outline-none transition ${bengaliClass}`}
                        />
                        <button
                          type="button"
                          onClick={() => setShowPassword(!showPassword)}
                          className="absolute right-3 top-3.5 text-gray-400 hover:text-[#E31E27] transition"
                        >
                  ...
                  <label className="flex items-start gap-3 cursor-pointer">
                    <div className={`w-5 h-5 rounded border-2 flex items-center justify-center transition ${termsAccepted ? 'bg-[#E31E27] border-[#E31E27]' : 'border-gray-300'}`}>
                    ...
                    <span className={`text-sm text-gray-600 ${bengaliClass}`}>
                      ...
                      <Link href="/terms" className="text-[#E31E27] font-medium hover:underline">
                        {language === "bn" ? "????????" : "Terms & Conditions"}
                      </Link>
                      {language === "bn" ? " ??? " : " and "}
                      <Link href="/privacy" className="text-[#E31E27] font-medium hover:underline">
                  ...
                  <button
                    ...
                    className={`w-full py-3.5 rounded-xl text-white font-semibold shadow-lg transition text-base ${loading || !termsAccepted
                      ...
                      : "bg-gradient-to-r from-[#E31E27] to-[#38a89d] hover:shadow-xl hover:-translate-y-0.5"
                      } ${bengaliClass}`}
                  >
                    {loading ? (
                  ...
                  <p className={`text-sm text-gray-500 text-center ${bengaliClass}`}>
                    ...
                    <Link href="/login" className="text-[#E31E27] font-semibold hover:underline">
                      {language === "bn" ? "???? ????" : "Sign in"}
                    </Link>
                  </p>
                </form>
