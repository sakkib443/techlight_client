    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#E31E27] via-[#3aa8a1] to-[#E31E27]" />
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="flex flex-col md:flex-row items-center gap-8">
                            ...
                            <div className="relative group">
                                <div className="absolute inset-0 bg-gradient-to-br from-[#E31E27] to-[#E31E27] rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity" />
            ...
            <div className="max-w-6xl mx-auto px-6 -mt-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                        { icon: FiBook, label: 'Enrolled Courses', value: '0', color: 'from-[#E31E27] to-[#3aa8a1]' },
                        { icon: FiAward, label: 'Certificates', value: '0', color: 'from-[#E31E27] to-[#e88a43]' },
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className={`rounded-3xl overflow-hidden ${isDark ? 'bg-slate-800/50 border border-slate-700/50' : 'bg-white border border-slate-200 shadow-xl'}`}>
                            <div className="p-6 bg-gradient-to-br from-[#E31E27] to-[#3aa8a1]">
                        ...
                        <div className={`rounded-3xl p-6 ${isDark ? 'bg-slate-800/50 border border-slate-700/50' : 'bg-white border border-slate-200 shadow-xl'}`}>
                            ...
                            <div className="space-y-3">
                                ...
                                <button className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all ${isDark ? 'bg-slate-700/50 hover:bg-slate-700 text-white' : 'bg-slate-50 hover:bg-slate-100 text-slate-700'}`}>
                                    <FiAward size={18} className="text-[#E31E27]" />
                        ...
                        <div className={`flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-6 border-b ${isDark ? 'border-slate-700/50' : 'border-slate-100'}`}>
                            ...
                            {!isEditing ? (
                                <button
                                    ...
                                    className="flex items-center gap-2 px-5 py-2.5 bg-[#E31E27] hover:bg-[#3aa8a1] text-white rounded-xl font-semibold text-sm transition-all shadow-lg shadow-[#E31E27]/25"
                                >
                                    <FiEdit3 size={16} />
                                    Edit Profile
                                </button>
